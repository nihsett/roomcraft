...
export const DEFAULT_ITEMS: Item[] = [
  { id: 'sofa-1',   type: 'sofa',         label: 'Sofa',         x: 140, y: 250, w: 220, d: 90,  rotation: 180 },
  { id: 'arm-1',    type: 'armchair',     label: 'Armchair',     x: 40,  y: 260, w: 85,  d: 85,  rotation: 180 },
  ...
  { id: 'dchair-1', type: 'dining-chair',  label: 'Chair 1',      x: 50,  y: 30,  w: 45,  d: 45,  rotation: 0 },
  { id: 'dchair-2', type: 'dining-chair',  label: 'Chair 2',      x: 125, y: 30,  w: 45,  d: 45,  rotation: 0 },
  { id: 'dchair-3', type: 'dining-chair',  label: 'Chair 3',      x: 50,  y: 175, w: 45,  d: 45,  rotation: 180 },
  { id: 'dchair-4', type: 'dining-chair',  label: 'Chair 4',      x: 125, y: 175, w: 45,  d: 45,  rotation: 180 },
];
